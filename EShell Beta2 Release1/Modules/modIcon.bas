...
Public Function Load32Icon(icon As String, index As Long, pic As Image)

frmConsole.picTemp.Cls
frmConsole.picTemp.BackColor = pic.Parent.BackColor
DrawIcon icon, frmConsole.picTemp, False, CLng(index)
SavePicture frmConsole.picTemp.Image, App.path & "\temp.bmp"
DoEvents
